...
Note that even if the _domain_ of a component is common, the requirements of
...
- [`google.api.*`](https://github.com/googleapis/googleapis/blob/master/google/api) (but _not_ subpackages of `google.api`)
...
"generic" and "organization-specific" is a gray area; some generic _concepts_
