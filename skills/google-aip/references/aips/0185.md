...
A _stability channel_ is a long-lived release at a given stability level that
...
An _individual release_ is an alpha or beta release that is expected to be
